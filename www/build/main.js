...
PrioritiesPage = priorities___decorate([
    priorities___WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"]({
        selector: 'page-priorities',template:/*ion-inline-start:"/Users/khalidsalah/Desktop/VA-ionicapp/src/pages/priorities/priorities.html"*/'\n<ion-header>\n</ion-header>\n<ion-content>\n    <div class="header">\n        <h4>Would you be interested in a shared decision making tool that allows you to share information with your provider about your goals for therapy and things that are important to you such as not feeling dizzy or not losing sleep at night with a medication?</h4>\n    </div>\n    <ion-list radio-group [(ngModel)]="questionOne">\n        <ion-row>\n            <ion-col>\n                <ion-item text-center class="question">\n                    <ion-label>Yes</ion-label>\n                    <br>\n                    \n                </ion-item>\n                <ion-item text-center class="option"><ion-radio mode="md" value="Yes"></ion-radio></ion-item>\n            </ion-col>\n            <ion-col>\n                <ion-item text-center class="question">\n                    <ion-label>No</ion-label>\n                    <br>\n                    \n                </ion-item>\n                <ion-item text-center class="option"><ion-radio mode="md" value="No"></ion-radio></ion-item>\n            </ion-col>\n        </ion-row>\n    </ion-list>  \n    <div class="header">\n        <h4>If Drug A and Drug B provided the same clinical benefit, which of the following options is more acceptable to you?</h4>\n    </div>\n    <ion-list radio-group [(ngModel)]="questionOne">\n        <ion-row>\n            <ion-col>\n                <ion-item text-center class="question">\n                    <ion-label>4 pills of drug A taken once a day\n                        <br> AND\n                        <br> A steroid taken twice a day</ion-label>\n                    <br>\n                   \n                </ion-item> \n                <ion-item text-center class="option"><ion-radio mode="md" value="A"></ion-radio></ion-item>\n            </ion-col>\n            <ion-col>\n                <ion-item text-center class="question">\n                    <ion-label>4 pills of drug B taken once a day\n                        <br> AND\n                        <br> Feeling dizzy</ion-label>\n                    <br>\n                    \n                </ion-item>\n                <ion-item text-center class="option"><ion-radio mode="md" value="B"></ion-radio></ion-item>\n            </ion-col>\n        </ion-row>\n    </ion-list>\n    <ion-item text-center class="button-next">\n        <button ion-button (click)="backButton()">\n            <ion-icon ios="ios-arrow-dropleft" md="ios-arrow-dropleft"></ion-icon>\n        </button>\n        <button ion-button (click)="homeButton()">\n            <ion-icon ios="ios-home" md="md-home"></ion-icon>\n        </button>\n        <button ion-button (click)="saveQuestionInfo()">\n            <ion-icon ios="ios-arrow-dropright" md="ios-arrow-dropright"></ion-icon>\n        </button>\n    </ion-item>\n</ion-content>\n\n'/*ion-inline-end:"/Users/khalidsalah/Desktop/VA-ionicapp/src/pages/priorities/priorities.html"*/
    }),
    priorities___metadata("design:paramtypes", [typeof (_a = typeof priorities___WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"] !== "undefined" && priorities___WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"]) === "function" && _a || Object, typeof (_b = typeof ResponseService !== "undefined" && ResponseService) === "function" && _b || Object])
], PrioritiesPage);
...
TreatmentPage = treatment___decorate([
    ...
    treatment___metadata("design:paramtypes", [typeof (treatment__a = typeof treatment___WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"] !== "undefined" && treatment___WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"]) === "function" && treatment__a || Object, typeof (treatment__b = typeof ResponseService !== "undefined" && ResponseService) === "function" && treatment__b || Object, typeof (_c = typeof treatment___WEBPACK_IMPORTED_MODULE_1_ionic_angular__["AlertController"] !== "undefined" && treatment___WEBPACK_IMPORTED_MODULE_1_ionic_angular__["AlertController"]) === "function" && _c || Object])
], TreatmentPage);

var treatment__a, treatment__b, _c;
